...
import ru.vorobiev.springcoure.Project2Boot.repositories.PeopleRepositories;
...
public class PeopleRepositoriesImpl {
    ...
    @Autowired
    public PeopleRepositoriesImpl(@Lazy PeopleRepositories peopleRepositories) {
    ...
    public Optional<Person> getPersonBuFullName(String fullName) {
        return peopleRepositories.findByFio(fullName);
    }
