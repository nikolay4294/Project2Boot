...
import ru.vorobiev.springcoure.Project2Boot.util.PersonValidator;
...
public class PeopleController {
    ...
    @Autowired
    public PeopleController(@Lazy PeopleRepositoriesImpl peopleService,@Lazy PersonValidator personValidator) {
